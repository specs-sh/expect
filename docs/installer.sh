...
EMOJI="🧐"
REPO_ORG="bx-sh"
PROJECT_NAME="expect.sh"
FILE_WITH_VERSION_VARIABLE="expect.sh"
VERSION_VARIABLE="EXPECT_VERSION"
API_LATEST_RELEASE_INFO_URL="https://api.github.com/repos/$REPO_ORG/$PROJECT_NAME/releases/latest"
FILES_TO_COPY=("core.sh" "expect.sh")
INSTALL_MESSAGE="Installed 🧐 expect.sh

- core.sh    Core Library w/o matchers
- expect.sh  Full Library w/  matchers

source \"core.sh\" or \"expect\" to start using!

Visit https://expectations.sh for documentation
"
########################
