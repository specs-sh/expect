...
source matchers/containPattern.sh
...
example.text.containPattern.fail() {
  e.g. assertThat : assertThat "Hello World" containsPattern "World"
  e.g. brackets   : [[: "Hello World" = "World" ]]
  e.g. expect     : expect "Hello World" to containPattern "World"
  e.g. should     : {{ "Hello World" }} should containPattern "World"
  assertStderr "Expected text value to contain pattern" 'Actual: "Hello World"' 'Pattern: "World"'
  assertEmptyStdout
  # assertExitcode 52
}

example.text.containPattern.pass() {
  e.g. assertThat : assertThat "Hello World" containsPattern "*World"
  e.g. brackets   : [[: "Hello World" = "*World" ]]
  e.g. expect     : expect "Hello World" to containPattern "*World"
  e.g. should     : {{ "Hello World" }} should containPattern "*World"
...
example.text.not.containPattern.fail() {
  e.g. assertThat : assertThat "Hello World" does not containPattern "*World"
  e.g. brackets   : [[: "Hello World" != "*World" ]]
  e.g. expect     : expect "Hello World" not to containPattern "*World"
  e.g. should     : {{ "Hello World" }} should not containPattern "*World"
  assertStderr "Expected text value not to contain pattern" 'Actual: "Hello World"' 'Pattern: "*World"'
  assertEmptyStdout
  # assertExitcode 52
}
